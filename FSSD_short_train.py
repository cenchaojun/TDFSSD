...
from data import VOCroot, COCOroot, VOC_300, VOC_512,VOC_short_512, COCO_300, COCO_512, AnnotationTransform, COCODetection, \
...
parser.add_argument('-d', '--dataset', default='VOC_short',

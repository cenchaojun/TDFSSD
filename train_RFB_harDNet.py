...
from data import VOCroot, COCOroot, VOC_300, VOC_512, COCO_300, COCO_512, AnnotationTransform, COCODetection, \
...
parser.add_argument('-v', '--version', default='RFB_HarDNet68',
...
parser.add_argument(
    '--basenet', default='weights/hardnet68_base_bridge.pth', help='pretrained base model')
...
def train():
    ...
    stepvalues_VOC = (150 * epoch_size, 200 * epoch_size, 350 * epoch_size)
    stepvalues_COCO = (100 * epoch_size, 120 * epoch_size, 140 * epoch_size)
    ...
    if args.visdom:
        ...
        epoch_lot = viz.line(
            ...
            opts=dict(
                xlabel='Epoch',
                ylabel='Loss',
                title='Epoch ' + args.version + ' Training Loss',
        ...
        if (iteration % epoch_size == 0):
            if args.visdom:
                viz.line(
                    ...
                    opts=dict(legend=['Loc Loss', 'Conf Loss', 'Loss']),
                    win=epoch_lot,
                    update='append'
                )
